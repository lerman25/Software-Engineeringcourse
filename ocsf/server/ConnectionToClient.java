...
// INSTANCE VARIABLES ***********************************************
	...
	/**
	 * Map to save information about the client such as its login ID. The initial
	 * size of the map is small since it is not expected that concrete servers will
	 * want to store many different types of information about each client. Used by
	 * the setInfo and getInfo methods.
	 */
...
// RUN METHOD -------------------------------------------------------
	...
	/**
	 * Constantly reads the client's input stream. Sends all objects that are read
	 * to the server. Not to be called.
	 */
